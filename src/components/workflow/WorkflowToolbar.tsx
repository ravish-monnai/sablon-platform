...
import { 
  ...
  MapPin, Network, IdCard, ChartBar 
} from 'lucide-react';
...
const WorkflowToolbar: React.FC<WorkflowToolbarProps> = ({ 
  ...
  const dataSources = [
    { type: "phone_data", label: "Phone Data", icon: <Phone className="text-blue-500 mr-2" size={16} /> },
    { type: "email_data", label: "Email Data", icon: <Mail className="text-indigo-500 mr-2" size={16} /> },
    { type: "location_data", label: "Location Data", icon: <MapPin className="text-red-500 mr-2" size={16} /> },
    { type: "network_data", label: "Network Data", icon: <Network className="text-green-500 mr-2" size={16} /> },
    { type: "identity_data", label: "Identity Data", icon: <IdCard className="text-amber-500 mr-2" size={16} /> },
  ];

  const models = [
    { type: "binary_model", label: "Binary Classifier", icon: <Brain className="text-pink-500 mr-2" size={16} /> },
    { type: "multi_model", label: "Multi-class Classifier", icon: <Brain className="text-purple-500 mr-2" size={16} /> },
    { type: "regression_model", label: "Regression Model", icon: <ChartBar className="text-blue-500 mr-2" size={16} /> },
  ];
