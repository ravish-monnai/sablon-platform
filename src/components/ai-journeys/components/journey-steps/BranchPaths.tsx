  ...
  return (
    <div className="absolute top-24 pt-6 w-full">
      <div className="relative flex justify-center">
        {/* Vertical connector */}
        <div className="absolute w-0.5 h-12 bg-gray-300 left-1/2 transform -translate-x-1/2 transition-colors duration-300 hover:bg-gray-400"></div>
        
        {/* Branch connector */}
        <div className="absolute top-12 w-full h-0.5 bg-gray-300 transition-colors duration-300 hover:bg-gray-400"></div>
